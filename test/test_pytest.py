...
def test_query_single_type_multi_date_csv(client):
    req = '/cases?data_type=active&locations=%7B%0A%20%20%22country%22%3A%20%22Canada%22%2C%0A%20%20%22state%22%3A%20%22British%20Columbia%22%2C%0A%20%20%22combined%22%3A%20%22%22%0A%7D&start_time=2020-01-23&end_time=2020-01-31'
...
def test_query_multi_type_single_date_csv(client):
    req = '/cases?data_type=active&data_type=recovered&locations=%7B%0A%20%20%22country%22%3A%20%22Canada%22%2C%0A%20%20%22state%22%3A%20%22British%20Columbia%22%2C%0A%20%20%22combined%22%3A%20%22%22%0A%7D&start_time=2020-01-23'
    response = client.get(req, headers={'accept': 'text/csv'})
    assert response.data == b'index,country_region,state_province,combined_key,date,cases,type\n0,Canada,British Columbia,,2020-01-23,2,active\n1,Canada,British Columbia,,2020-01-23,2,recovered\n'


def test_query_single_type_single_date_json(client):
    req = '/cases?data_type=active&locations=%7B%0A%20%20%22country%22%3A%20%22Canada%22%2C%0A%20%20%22state%22%3A%20%22British%20Columbia%22%2C%0A%20%20%22combined%22%3A%20%22%22%0A%7D&start_time=2020-01-23'
    response = client.get(req, headers={'accept': 'application/json'})
